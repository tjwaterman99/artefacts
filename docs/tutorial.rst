...
But if you open that file in your text editor, you'll likely see a large amount of complex data. In fact, the :code:`manifest.json` file generated by my company's project is hundreds of thousands of lines long. 
...
Instead, we can trying using artefacts simple, documented API for parsing the dbt artifact.
